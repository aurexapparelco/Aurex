  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <span
          className="block text-xs tracking-[0.18em] uppercase mt-2"
          ...
          return (
            <Link
              ...
              style={{
                ...
                backgroundColor: active ? "rgba(212,162,76,0.08)" : "transparent",
                fontFamily: "var(--font-body)",
              }}
            >
              <span style={{ color: active ? "var(--color-gold-400)" : "var(--color-fg-tertiary)" }}>
                {icon}
              </span>
              {label}
            </Link>
