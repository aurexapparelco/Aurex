...
export const metadata: Metadata = { title: "Product Types | Admin" };
    ...
    >
      <div className="mb-8">
        ...
        <p className="text-sm mt-1" style={{ color: "var(--color-fg-muted)" }}>
          Manage the clothing categories shown across the storefront.
        </p>
      </div>

      <ProductTypesManager initialTypes={types ?? []} />
    </div>
  );
}
